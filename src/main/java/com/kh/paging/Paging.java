...
public class Paging {
	...
	// 페이징 생성자
	public Paging(int currentPage, int totalCount, int blockCount, int blockPage, String dogName) {
	...
	// Search있는 생성자
	public Paging(int currentPage, int totalCount, int blockCount, int blockPage, String dogName, int searchNum,
			String isSearch) {
