			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							<a href="/ModuHome/admin/reviewAdmin"><button type="button" class="btn btn-outline btn-default">전체</button></a>													
						</div>
								...
								<tbody>
									<c:forEach var="adminMgList" items="${adminMgList}" varStatus="stat">
										...
										<tr class="gradeA even" role="row">
											...
											<img src="/ModuHome/style/img/${adminMgList.MG_TITLE_IMAGE}" width="50" height="50" alt=""  onerror="this.src='/ModuHome/images/noimg_130.gif'" />
											</c:if>
											...
											<td style="text-align: center; vertical-align: middle;"><fmt:formatDate value="${adminMgList.MG_REGDATE}" pattern="YY.MM.dd HH:mm" /></td>
											<td style="text-align: center; vertical-align: middle;">
												<c:url var="viewURL" value="/mgdelete">
													<c:param name="MG_NUMBER" value="${adminMgList.MG_NUMBER }" />
													<c:param name="image" value="${adminMgList.MG_TITLE_IMAGE }" />
												</c:url>
