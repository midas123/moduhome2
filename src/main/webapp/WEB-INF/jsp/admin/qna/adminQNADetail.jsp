	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form:form id="frm" name="frm" action="frm" method="post" enctype="multipart/form-data">
				...
				<c:choose>
					<c:when test="${qnaDetail.QNA_IMAGE != null}">
						<div class="form-group">
							<label>등록 이미지</label>
						</div>
						<div class="form-group">
							<img src="/ModuHome/images/qna/${qnaDetail.QNA_IMAGE}" alt="" onerror="this.src='/ModuHome/images/noimg_130.gif'" style="width: 650px;" />
						</div>
					</c:when>
				</c:choose>
				<div class="form-group">
