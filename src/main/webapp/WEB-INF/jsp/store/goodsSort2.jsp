...
<html>
<head>
<script src="/ModuHome/js/store/jquery-1.11.0.min.js"></script>
<script src="/ModuHome/js/store/jquery-ui.js"></script>
<script src="/ModuHome/js/store/jquery-migrate-1.2.1.min.js"></script>	
