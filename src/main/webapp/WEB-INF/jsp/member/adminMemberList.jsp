			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							<a href="/ModuHome/admin/memberList"><button type="button" class="btn btn-outline btn-default">전체</button></a>													
						</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<table
								...
								<thead>
									<tr role="row">
										<th style="width: 5%; text-align: center;">회원번호</th>
										<th style="width: 10%; text-align: center;">회원ID</th>
										<th style="width: 10%; text-align: center;">회원이름</th>
								...
								<tbody>
									<c:forEach var="adminMemberList" items="${adminMemberList}" varStatus="stat">
										
										<tr class="gradeA even" role="row">
											<td style="text-align: center; vertical-align: middle;">${adminMemberList.MEMBER_NUMBER}</td>
											<td style="text-align: center; vertical-align: middle;">${adminMemberList.MEMBER_ID}</td>
											<td style="text-align: center; vertical-align: middle;">${adminMemberList.MEMBER_NAME}</td>
											<td style="text-align: center; vertical-align: middle;">${adminMemberList.MEMBER_NICKNAME}</td>
											<td style="text-align: center; vertical-align: middle;">
											<c:if test="${adminMemberList.STORED_FILE_NAME ne null}">
											<img src="/ModuHome/images/member/${adminMemberList.STORED_FILE_NAME}" width="50" height="50" alt=""  onerror="this.src='/ModuHome/images/noimg_130.gif'" />
											</c:if>
											</td>
