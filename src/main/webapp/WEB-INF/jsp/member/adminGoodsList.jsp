							...
							<table
								...
								<c:url var="viewURL" value="/goods/goodsModifyForm" >
									...
									<tr class="gradeA even" role="row">
										...
										<td style="text-align:center;vertical-align:middle;"><img src="/MODA/file/goodsFile/${goodsList.GOODS_THUMBNAIL}" width="60" height="60" alt=""  onerror="this.src='/MODA/file/noimg_130.gif'" /><div style='display:none;'>${goodsList.GOODS_NUMBER}</div></td>
